    ...
    <footer class="rodape">
        <div class="rodape__linha-1">
            <div class="container">
                <div class="rodape__coluna">
                    ...
                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptatibus repellendus impedit cumque inventore minus eos consectetur placeat, quaerat odit officia repudiandae, consequatur quis, unde beatae optio voluptas aliquid atque iure.</p>
                </div>
                <div class="rodape__coluna">
                    <h2 class="rodape__titulo">Social</h2>
                    <ul class="rodape__lista-links">
                        <li><a class="rodape__lista-links__item" href="https://twitter.com/mariarsv" target="_blank">Twitter</a></li>
        ...
        <div class="rodape__linha-2">
            © <?php echo date('Y') ?> - Todos os direitos reservados - Maria Ventura
        </div>
    </footer>
